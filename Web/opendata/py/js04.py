...
for data in table['records']['location']:
	...
	str1 = "http://mosquitotrap.nhri.org.tw/"
	str2 = "opendata/rainadd1.php?f01=%s&f03=%s&f04=%s&f05=%s&f06=%s&f07=%s&f08=%s&f09=%s&f10=%s&f11=%s&f12=%s&f13=%s&f15=%s" %(s01, s03, s04, s05, s06, s07, s08, s09, s10, s11, s12, s13,  s15)
...
#	conn.request("GET", (str1+str2).encode('utf-8'))
#	res=conn.requests.get((str1+str2).encode('utf-8'),timeout=2.50)
