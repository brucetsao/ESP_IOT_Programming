    ...
    <script type="text/javascript">
        ...
        map.on('load', function(){
            map.addSource('cwbvalue', {
                'type': 'geojson',
                'data': cwbdata // 此範例所使用的檔案請見 https://www.map8.zone/js/vector/heatmap.json
            });
                map.addSource('particlevalue', {
                    type: 'geojson',
                    data: data
                });
...
//----------------------------------
            ...
            map.once('idle', function () {
                ...
                map.setFilter('circles', ['==', 'species', 'PM25']);
                map.setFilter('numbers', ['==', 'species', 'PM25']);
                // 切換選項按鈕
