...
//2019-11-22 20:03:55
	...
	$query = "INSERT INTO rfidreader05 (mac,cardnumber,inputdatetime) 
	VALUES ('".$temp1."','".$temp2."','".$dt."')"; 
	//組成新增到dhtdata資料表的SQL語法
//http://192.168.99.200/iot/rfid/dataadd05.php?mac=aabbccddeeff&card=0123456789
//http://192.168.99.200/iot/rfid/dataadd05.php?mac=aabbccddeeff&card=0345678134
// host is  ==>192.168.99.200
//  app program is ==> /iot/dht/dataadd05.php
