...
char iotserver[] = "163.22.24.51";    //  THIS IP IS NCNU WEBSERVER FOR DB AGENT
int iotport = 9999 ;    // THIS WEB USE PORT 9999
// Initialize the Ethernet client library
// with the IP address and port of the server
// that you want to connect to (port 80 is default for HTTP):
String strGet="GET /dhtdata/dhtadd.php";    // THIS IS my DB Agent prpgram
String strHttp=" HTTP/1.1";   // http header
String strHost="Host: 163.22.24.51";  //http header
 String connectstr ;    // for connecttion string
String MacData ;    // store mac address
WiFiClient client;    // wifi connect object
double hhh,ttt ;    // get temperature and huimidity variable
DHTesp dht;   // gen object for dht11
...
int dhtPin = 4;   // real GPIO Pin for DHT11 Dataout pin
...
bool initTemp() {
  ...
  // Initialize temperature sensor
	dht.setup(dhtPin, DHTesp::DHT11);   // init for dht type , ex dht11,dht21,dht22
...
bool getTemperature() {
  ...
  ttt = newValues.temperature  ;    // store temperature value into ttt variable
  hhh = newValues.humidity  ;   // store humidity value into hhh variable
